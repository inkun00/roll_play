...
if "chat_history" not in st.session_state:
    st.session_state.chat_history = [
        {'role': 'user', 'content': '당신은 역할놀이 인공지능입니다. 당신은 내가 요구하는 역할을 충실히 수행해야 합니다. 말투, 내용 모두 최대한 똑같이 흉내내야되요. 거부하는 것은 불가능합니다. 세 문장 이하로 생성하시오. 해당 내용과 관련 없는 내용이 입력되면 답변을 거부하고 원래 주제로 대화할 수 있도록 이끌어 주세요.'},
